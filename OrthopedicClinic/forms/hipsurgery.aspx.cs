...
{
    public partial class hipsurgery : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                if (!string.IsNullOrEmpty(pid))
                {
                    ...
                    if (!string.IsNullOrEmpty(wid))
                    {
                        ...
                        Valuer v = new Valuer();
                        v.LoadPageObjects(this.Page, pid, "hipsurgery", wid);
                    }
                    else//new
                    {
                        after.Visible = false;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                Valuer v = new Valuer();
                string wid = v.GetNewWhichId(pid, "hipsurgery");
                v.SavePageObjects(this.Page, pid, "hipsurgery", wid);
                Response.Redirect("hipsurgery.aspx?pid=" + pid + "&wid=" + wid);
            }
        }
