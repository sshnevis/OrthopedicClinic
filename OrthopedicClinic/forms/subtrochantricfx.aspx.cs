...
{
    public partial class subtrochantricfx : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                if (!string.IsNullOrEmpty(pid))
                {
                    ...
                    if (!string.IsNullOrEmpty(wid))
                    {
                        ...
                        Valuer v = new Valuer();
                        v.LoadPageObjects(this.Page, pid, "subtrochantricfx", wid);
                    }
                    else//new
                    {
                        after.Visible = false;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                Valuer v = new Valuer();
                string wid = v.GetNewWhichId(pid, "subtrochantricfx");
                v.SavePageObjects(this.Page, pid, "subtrochantricfx", wid);
                Response.Redirect("subtrochantricfx.aspx?pid=" + pid + "&wid=" + wid);
            }
        }
