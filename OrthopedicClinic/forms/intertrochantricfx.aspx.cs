...
{
    public partial class intertrochantricfx : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                if (!string.IsNullOrEmpty(pid))
                {
                    ...
                    if (!string.IsNullOrEmpty(wid))
                    {
                        ...
                        Valuer v = new Valuer();
                        v.LoadPageObjects(this.Page, pid, "intertrochantricfx", wid);
                    }
                    else//new
                    {
                        after.Visible = false;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                Valuer v = new Valuer();
                string wid = v.GetNewWhichId(pid, "intertrochantricfx");
                v.SavePageObjects(this.Page, pid, "intertrochantricfx", wid);
                Response.Redirect("intertrochantricfx.aspx?pid=" + pid + "&wid=" + wid);
            }
        }
