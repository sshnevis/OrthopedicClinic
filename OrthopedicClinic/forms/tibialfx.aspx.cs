...
{
    public partial class tibialfx : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                if (!string.IsNullOrEmpty(pid))
                {
                    ...
                    if (!string.IsNullOrEmpty(wid))
                    {
                        ...
                        Valuer v = new Valuer();
                        v.LoadPageObjects(this.Page, pid, "tibialfx", wid);
                    }
                    else//new
                    {
                        after.Visible = false;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                Valuer v = new Valuer();
                string wid = v.GetNewWhichId(pid, "tibialfx");
                v.SavePageObjects(this.Page, pid, "tibialfx", wid);
                Response.Redirect("tibialfx.aspx?pid=" + pid + "&wid=" + wid);
            }
        }
