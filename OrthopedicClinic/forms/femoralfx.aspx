<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="femoralfx.aspx.cs" Inherits="OrthopedicClinic.forms.femoralfx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderSection" runat="server">
    <div id="rowpage" runat="server">
        <div class="page-header">
            <div class="row">
                <div class="col-md-5">
                    <h1>Femoral Fx <a class="btn btn-default" href="<%= string.Format("/personal.aspx?pid={0}", Request.QueryString["pid"]) %>">Back</a></h1>
                    ...
                    <div class="row" id="RowBefore" runat="server">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" runat="server" id="chkSavedNonoperative" />
                                        Nonoperative
                                    </label>
                                    <label>
                                    ...
                                    <label>
                                        <input type="checkbox" runat="server" id="chkSavedDHS" />
                                        DHS
                                    </label>
                                    <label>
                                        <input type="checkbox" runat="server" id="chkSavedPlateFixation" />
                                        Plate Fixation
                                    </label>
                                    <label>
                 ...
                 <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="txtSavedKneePhysiotherapy" runat="server" disabled=""  type="text" />
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="control-label" >Knee ROM :</label>
                                <input class="form-control" id="txtSavedKneeROM" runat="server" disabled=""  type="text" />
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="control-label" >medication(DVT prophylaxis) :</label>
