...
{
    public partial class recurrentdx : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                if (!string.IsNullOrEmpty(pid))
                {
                    ...
                    if (!string.IsNullOrEmpty(wid))
                    {
                        ...
                        Valuer v = new Valuer();
                        v.LoadPageObjects(this.Page, pid, "recurrentdx", wid);
                    }
                    else//new
                    {
                        after.Visible = false;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                Valuer v = new Valuer();
                string wid = v.GetNewWhichId(pid, "recurrentdx");
                v.SavePageObjects(this.Page, pid, "recurrentdx", wid);
                Response.Redirect("recurrentdx.aspx?pid=" + pid + "&wid=" + wid);
            }
        }
