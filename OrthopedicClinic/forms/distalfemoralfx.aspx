<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="distalfemoralfx.aspx.cs" Inherits="OrthopedicClinic.forms.distalfemoralfx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderSection" runat="server">
    <div id="rowpage" runat="server">
        <div class="page-header">
            <div class="row">
                <div class="col-md-5">
                    <h1>Distal Femoral Fx <a class="btn btn-default" href="<%= string.Format("/personal.aspx?pid={0}", Request.QueryString["pid"]) %>">Back</a></h1>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="checkbox">
                                    ...
                                    <label>
                                        <input type="checkbox" runat="server" id="chkSavedRetrogradeNailing" />
                                        Retrograde Nailing 
                                    </label>
