<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="femoralneckfx.aspx.cs" Inherits="OrthopedicClinic.forms.femoralneckfx" %>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="checkbox">
                                    ...
                                    <label>
                                        <input type="checkbox" runat="server" id="chkSavedScrewFixation" />
                                        Screw Fixation
                                    </label>
                                    <label>
