...
{
    public partial class scoliosis : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                if (!string.IsNullOrEmpty(pid))
                {
                    ...
                    if (!string.IsNullOrEmpty(wid))
                    {
                        ...
                        Valuer v = new Valuer();
                        v.LoadPageObjects(this.Page, pid, "scoliosis", wid);
                    }
                    else//new
                    {
                        after.Visible = false;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                Valuer v = new Valuer();
                string wid = v.GetNewWhichId(pid, "scoliosis");
                v.SavePageObjects(this.Page, pid, "scoliosis", wid);
                Response.Redirect("scoliosis.aspx?pid=" + pid + "&wid=" + wid);
            }
        }
