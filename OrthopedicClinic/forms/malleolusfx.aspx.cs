...
{
    public partial class malleolusfx : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                if (!string.IsNullOrEmpty(pid))
                {
                    ...
                    if (!string.IsNullOrEmpty(wid))
                    {
                        ...
                        Valuer v = new Valuer();
                        v.LoadPageObjects(this.Page, pid, "malleolusfx", wid);
                    }
                    else//new
                    {
                        after.Visible = false;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                Valuer v = new Valuer();
                string wid = v.GetNewWhichId(pid, "malleolusfx");
                v.SavePageObjects(this.Page, pid, "malleolusfx", wid);
                Response.Redirect("malleolusfx.aspx?pid=" + pid + "&wid=" + wid);
            }
        }
