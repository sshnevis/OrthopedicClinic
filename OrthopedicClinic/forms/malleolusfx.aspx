<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="malleolusfx.aspx.cs" Inherits="OrthopedicClinic.forms.malleolusfx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderSection" runat="server">
    <div id="rowpage" runat="server">
        <div class="page-header">
            <div class="row">
                <div class="col-md-5">
                    <h1>Malleolus Fx <a class="btn btn-default" href="<%= string.Format("/personal.aspx?pid={0}", Request.QueryString["pid"]) %>">Back</a></h1>
            ...
            <div class="<%--form-horizontal--%>">
                <fieldset>
                    ...
                    <div class="row" id="RowBefore" runat="server">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="control-label">Fx :</label>
                                <select id="ddlSavedFx" class="form-control" runat="server" disabled="">
                                    <option>Medial</option>
                                    <option>lateral</option>
                                    <option>bimalleolar</option>
                                    <option>trimalleolar</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="checkbox">
                                    ...
                                    <label>
                                        <input type="checkbox" runat="server" id="chkSavedLockingPlate" />
                                        Locking plate
                                    </label>
                                    <label>
                                        <input type="checkbox" runat="server" id="chkSavedScrew" />
                                        Screw
                                    </label>
                                    <label>
                                        <input type="checkbox" runat="server" id="chkSavedTensionBand" />
                                        Tension Band 
                                    </label>
