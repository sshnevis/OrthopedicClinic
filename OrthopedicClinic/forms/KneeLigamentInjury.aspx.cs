...
{
    public partial class KneeLigamentInjury : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                if (!string.IsNullOrEmpty(pid))
                {
                    ...
                    if (!string.IsNullOrEmpty(wid))
                    {
                        ...
                        Valuer v = new Valuer();
                        v.LoadPageObjects(this.Page, pid, "KneeLigamentInjury", wid);
                    }
                    else//new
                    {
                        after.Visible = false;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                Valuer v = new Valuer();
                string wid = v.GetNewWhichId(pid, "KneeLigamentInjury");
                v.SavePageObjects(this.Page, pid, "KneeLigamentInjury", wid);
                Response.Redirect("KneeLigamentInjury.aspx?pid=" + pid + "&wid=" + wid);
            }
        }
