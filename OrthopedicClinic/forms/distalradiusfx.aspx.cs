...
{
    public partial class distalradiusfx : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                if (!string.IsNullOrEmpty(pid))
                {
                    ...
                    if (!string.IsNullOrEmpty(wid))
                    {
                        ...
                        Valuer v = new Valuer();
                        v.LoadPageObjects(this.Page, pid, "distalradiusfx", wid);
                    }
                    else//new
                    {
                        after.Visible = false;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                Valuer v = new Valuer();
                string wid = v.GetNewWhichId(pid, "distalradiusfx");
                v.SavePageObjects(this.Page, pid, "distalradiusfx", wid);
                Response.Redirect("distalradiusfx.aspx?pid=" + pid + "&wid=" + wid);
            }
        }
