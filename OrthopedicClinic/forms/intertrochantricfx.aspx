<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="intertrochantricfx.aspx.cs" Inherits="OrthopedicClinic.forms.intertrochantricfx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderSection" runat="server">
    <div id="rowpage" runat="server">
        <div class="page-header">
            <div class="row">
                <div class="col-md-5">
                    <h1>Intertrochantric Fx <a class="btn btn-default" href="<%= string.Format("/personal.aspx?pid={0}", Request.QueryString["pid"]) %>">Back</a></h1>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="checkbox">
                                    ...
                                    <label>
                                        <input type="checkbox" runat="server" id="chkSavedDCS" />
                                        DCS
                                    </label>
                                    <label>
                                        <input type="checkbox" runat="server" id="chkSavedPFNA" />
                                        PFNA
                                    </label>
                                    <label>
                                    ...
                                    <label>
                                        <input type="checkbox" runat="server" id="chkSavedArthroplasty" />
                                        Arthroplasty
                                    </label>
