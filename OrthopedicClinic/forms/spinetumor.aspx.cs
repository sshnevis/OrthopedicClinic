...
{
    public partial class SpineTumor : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                if (!string.IsNullOrEmpty(pid))
                {
                    ...
                    if (!string.IsNullOrEmpty(wid))
                    {
                        ...
                        Valuer v = new Valuer();
                        v.LoadPageObjects(this.Page, pid, "spinetumor", wid);
                    }
                    else//new
                    {
                        after.Visible = false;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                Valuer v = new Valuer();
                string wid = v.GetNewWhichId(pid, "spinetumor");
                v.SavePageObjects(this.Page, pid, "spinetumor", wid);
                Response.Redirect("spinetumor.aspx?pid=" + pid + "&wid=" + wid);
            }
        }
