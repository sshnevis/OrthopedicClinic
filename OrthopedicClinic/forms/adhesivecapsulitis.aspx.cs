...
{
    public partial class adhesivecapsulitis : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                if (!string.IsNullOrEmpty(pid))
                {
                    ...
                    if (!string.IsNullOrEmpty(wid))
                    {
                        ...
                        Valuer v = new Valuer();
                        v.LoadPageObjects(this.Page, pid, "adhesivecapsulitis", wid);
                    }
                    else//new
                    {
                        after.Visible = false;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                Valuer v = new Valuer();
                string wid = v.GetNewWhichId(pid, "adhesivecapsulitis");
                v.SavePageObjects(this.Page, pid, "adhesivecapsulitis", wid);
                Response.Redirect("adhesivecapsulitis.aspx?pid=" + pid + "&wid=" + wid);
            }
        }
