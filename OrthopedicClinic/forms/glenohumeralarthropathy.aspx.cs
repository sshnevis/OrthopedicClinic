...
{
    public partial class glenohumeralarthropathy : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                if (!string.IsNullOrEmpty(pid))
                {
                    ...
                    if (!string.IsNullOrEmpty(wid))
                    {
                        ...
                        Valuer v = new Valuer();
                        v.LoadPageObjects(this.Page, pid, "glenohumeralarthropathy", wid);
                    }
                    else//new
                    {
                        after.Visible = false;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                Valuer v = new Valuer();
                string wid = v.GetNewWhichId(pid, "glenohumeralarthropathy");
                v.SavePageObjects(this.Page, pid, "glenohumeralarthropathy", wid);
                Response.Redirect("glenohumeralarthropathy.aspx?pid=" + pid + "&wid=" + wid);
            }
        }
